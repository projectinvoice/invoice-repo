...
urlpatterns = [
    ...
    path('activer-compte/<uidb64>/<token>/', invoice_views.activate_account, name='activate_account'),
    path('renvoyer-activation/', invoice_views.resend_activation_email, name='resend_activation_email'),
